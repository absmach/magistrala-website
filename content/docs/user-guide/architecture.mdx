...
| [consumers][consumers]           | An abstraction of Magistrala consumers that receives messages                           |
| [email][email]                   | Magistrala Email Agent is used for sending emails                                       |
| [provision][provision]           | Provides a HTTP API to interact with Magistrala and setup configurations                |
