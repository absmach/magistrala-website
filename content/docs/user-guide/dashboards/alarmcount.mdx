...
The **Alarm Count** widget displays the total number of alarms based on your filter criteria. The card shows a large themed icon on the left and the alarm count with its label on the right, giving a clear at-a-glance view of system alerts.
