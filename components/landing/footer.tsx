        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-[15px] text-muted-foreground leading-relaxed mb-5">
              Open-source IoT platform for cloud and edge computing by Abstract Machines.
            </p>
            <div className="flex items-center gap-3">
              ...
              <SocialLink href="https://www.linkedin.com/company/abstract-machines" label="LinkedIn">
                <svg viewBox="0 0 24 24" className="size-4" fill="currentColor">
              ...
              <SocialLink href="https://www.youtube.com/@absmach" label="YouTube">
                <svg viewBox="0 0 24 24" className="size-4" fill="currentColor">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-[15px] text-muted-foreground hover:text-foreground transition-colors"
                >
              ...
              <li className="flex items-start gap-2.5 text-[15px] text-muted-foreground">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-base font-semibold text-foreground mb-4">Newsletter</h4>
            ...
            >
              <div className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 h-10 rounded-lg border border-border bg-background px-3 text-[15px] placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#073763]/20 focus:border-[#073763]/30"
                />
                <input type="hidden" name="tags" value="8115258" />
                <div style={{ position: "absolute", left: "-5000px" }} aria-hidden="true">
                  <input type="text" name="b_70b43c7181d005024187bfb31_0a319b6b63" tabIndex={-1} defaultValue="" />
                </div>
                <button
                  type="submit"
                  className="h-10 px-4 rounded-lg bg-[#073763] text-white text-[15px] font-medium hover:bg-[#0a4a82] transition-colors"
                >
                  Subscribe
                </button>
              </div>
