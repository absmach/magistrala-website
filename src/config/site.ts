...
export const USE_CASES: readonly UseCase[] = [
  {
    ...
    summary: 'Monitor water consumption in real time, detect leaks early, and generate threshold-based alarms for anomalies.',
    description:
  ...
  },
  {
    ...
    summary: 'Track equipment health, predict failures, and reduce downtime on the factory floor.',
    description:
  ...
  },
  {
    ...
    summary: 'Manage HVAC, lighting, occupancy, and energy across multi-site facilities from a single platform.',
    description:
  ...
  },
  {
    ...
    summary: 'Track vehicles and mobile assets with GPS telemetry, geofencing alarms, and route analytics.',
    description:
  ...
  },
  {
    ...
    summary: 'Monitor soil moisture, weather stations, and irrigation systems across distributed farmland.',
    description:
  ...
  },
  {
    ...
    summary: 'Monitor distributed energy resources, detect grid faults, and balance load across substations.',
    description:
...
export const PRICING_PLANS = [
  {
    ...
    cta: { label: 'Sign Up', href: 'https://cloud.magistrala.absmach.eu/register' },
    highlighted: false,
  },
  {
    name: 'Enterprise',
...
export const STRUCTURED_DATA = {
  organization: {
    ...
    description: 'IoT infrastructure and security company specializing in open-source IoT platforms',
    address: {
      '@type': 'PostalAddress',
